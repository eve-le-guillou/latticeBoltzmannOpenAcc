...
//#pragma acc parallel loop copy(rho_d[0:ms], u_d[0:ms], v_d[0:ms], r_f_d[0:ms*9], b_f_d[0:ms*9], f_d[0:9*ms], r_rho_d[0:ms], b_rho_d[0:ms], p_in_d[0:ms], p_out_d[0:ms], num_in_d[0:ms], num_out_d[0:ms], cg_direction[0:ms])
//#pragma acc kernels copy(rho_d[0:ms], u_d[0:ms], v_d[0:ms], r_f_d[0:ms*9], b_f_d[0:ms*9], f_d[0:9*ms], r_rho_d[0:ms], b_rho_d[0:ms], p_in_d[0:ms], p_out_d[0:ms], num_in_d[0:ms], num_out_d[0:ms], cg_direction[0:ms])
//#pragma acc loop
