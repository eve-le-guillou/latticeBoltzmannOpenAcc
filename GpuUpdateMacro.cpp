		...
		int *num_in_d, int *num_out_d, int test_case)
{
	...
	#pragma acc parallel loop present(rho_d[0:ms], u_d[0:ms], v_d[0:ms], w_d[0:ms], r_f_d[0:ms*19], b_f_d[0:ms*19], f_d[0:19*ms], r_rho_d[0:ms], b_rho_d[0:ms], p_in_d[0:ms], p_out_d[0:ms], num_in_d[0:ms], num_out_d[0:ms], bcMask_d[0:ms]) firstprivate(g, updateInltOutl) num_gangs(GANGS) vector_length(512) async
