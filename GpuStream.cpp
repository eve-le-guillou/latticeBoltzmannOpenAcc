...
#pragma acc data deviceptr(r_f, r_mf, b_f, b_mf) present(stream_d[0:ms*8], r_f_d[0:ms*9],b_f_d[0:ms*9]) present(r_fColl_d[0:9*ms], b_fColl_d[0:9*ms], cg_dir_d[0:ms]) async
#pragma acc parallel loop num_gangs(gangs) vector_length(THREADS) async
