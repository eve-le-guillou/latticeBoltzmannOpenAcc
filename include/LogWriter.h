 ...
 * @author Maciej Kubat (m.j.kubat@cranfield.ac.uk) - development into the 3D version
 */
#ifndef LOG_WRITER_H
#define LOG_WRITER_H
 ...
 */
void writeInitLog(const char* filename, Arguments *args, FLOAT_TYPE delta, int m, int n,int h,
...
void writeMacroDiffs(int iter,FLOAT_TYPE u, FLOAT_TYPE v, FLOAT_TYPE w, FLOAT_TYPE rho);
/**
