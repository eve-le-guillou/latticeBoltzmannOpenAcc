 ...
 * @file ArrayUtils.h
 * @author Adam Koleszar (adam.koleszar@gmail.com) - functions used in the 2D solver
 * @author Maciej Kubat (m.j.kubat@cranfield.ac.uk) - development of new functions, used in 3D solver
 */
...
#define THREADS 32 ///< number of threads used for kernels
...
#define SIZELONGLONG(a) ((a)*sizeof(unsigned long long))
/**
 ...
 * @return new array
 */
bool *createHostArrayBool(int length, ArrayOption op=ARRAY_NONE, bool fill=0, bool *copy=NULL);
int *createHostArrayInt(int length, ArrayOption op=ARRAY_NONE, int fill=0, int *copy=NULL);
unsigned long long *createHostArrayLongLong(int length, ArrayOption op=ARRAY_NONE, unsigned long long fill=0LL, unsigned long long *copy=NULL);
 ...
 * @return new array
 */
//bool *createGpuArrayBool(int length, ArrayOption op=ARRAY_NONE, bool fill=0, bool *copy=NULL);
//int *createGpuArrayInt(int length, ArrayOption op=ARRAY_NONE, int fill=0, int *copy=NULL);
//unsigned long long  *createGpuArrayLongLong(int length, ArrayOption op=ARRAY_NONE, unsigned long long fill=0LL, unsigned long long *copy=NULL);
/**
